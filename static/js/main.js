		...
		if (hasCounters) {
			...
			var waypoint = new Waypoint({
			  ...
			  handler: function() {
					...
					// Counter 1
					var counter1 = new CountUp('count-1', 0, 5, 0, 3, options);
					counter1.start();
					// Counter 2
					var counter2 = new CountUp('count-2', 0, 31552, 0, 3, options);
					counter2.start();
					// Counter 3
					var counter3 = new CountUp('count-3', 0, 47642, 0, 3, options);
					counter3.start();
					// Counter 4
					var counter4 = new CountUp('count-4', 0, 14, 0, 3, options);
					counter4.start();
					// init only once
					this.destroy();
				},
